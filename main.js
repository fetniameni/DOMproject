...
function removeCartItem(event) {
    ...
    buttonClicked.parentEtement.remove();
    updatetotal();
}
//Quantity Changes
...
function addProductToCart(title, price, productImg) {
    ...
    document.getElementsByClassName("cart-remove")[0].addEventListener("click", removeCartItem);
    document.getElementsByClassName("cart-quantity")[0].addEventListener("change", quantityChanged);
}
...
function updatetotal() {
    ...
    for (var i = 0; i < cartBoxes.length; i++) {
        ...
        var quantityElement = document.getElementsByClassName("cart-quantity")[0].value;
